<?
	...
	if ($_POST['submit'] == "update") {
        $sql = "UPDATE $tablename SET name='{$_POST['name']}', shortdesc='{$_POST['shortdesc']}' WHERE id='{$_GET['id']}'";
        mysql_query($sql);
    ...
    if ($_POST['submit'] == "add") {
// insert query
		$sql = "INSERT INTO $tablename SET name='{$_POST['name']}', shortdesc='{$_POST['shortdesc']}'";
		mysql_query($sql);
		header("Location: sku.php");
	}
// remove project
...
<table border="0" cellspacing="0" cellpadding="8" style="width: 100%; border: 0px solid #000000;">
	<tr>
		<td bgcolor="#FAFAFA" class="content" style="font-weight: bold; text-decoration: underline;">SKUs</td>
	</tr>
	<tr>
		<td style="padding: 14px;" class="content">
			<form action="" method="post">
				<table cellpadding="5" cellspacing="0" style="width: 100%; border: 0px;">
					...
					<tr>
						<td class="content" style="width: 120px;">SKU shortdescription</td>
						<td colspan="2" style="color: #000000; background: inherit;">
							<input type="text" name="shortdesc" value="<?= $shortdesc ?>" style="width: 500px;" class="content" />
						</td>
					</tr>
                    <tr>
						<td colspan="2">
							<table cellpadding="0" cellspacing="5" style="border: 0px; width: 100%;">
								<tr>
			                        <td align="center" style="padding-top: 20px; width: 50%;">
											<input type="button" class="inputbutton" value="go back" onclick="window.location='sku.php';" />
									</td>
									<td align="center" style="padding-top: 20px; width: 50%;">
