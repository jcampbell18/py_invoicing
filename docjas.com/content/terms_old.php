                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 71px; height: 37px; padding: 0px;">
                                                                            <a href="main.php?page=terms_&amp;id=<?= $id ?>" style="border: 0px; text-decoration: none;">
                                                                                <img src="imgs/button_view.jpg" alt="button_view.jpg" style="width: 60px; height: 37px; border: 0px; margin: 0px auto; padding: 0px;">
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
