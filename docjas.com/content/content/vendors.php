...
?>            
                                                            <div style="margin: 0px; padding: 3px 25px 0px 25px; border: 0px; text-align: left; vertical-align: top;">
                                                                <table>
                                                                    <tr>
                                                                        <td style="width: 250px; height: 37px; padding: 0px;"><?= $name ?></td>
                                                                        <td style="width: 606px; height: 37px; padding: 0px;"><?= $address.", ".$city.", ".$state." ".$zipcode ?></td>
                                                                        <td style="width: 44px; height: 37px; padding: 0px;">
                                                                            <a href="main.php?page=vendors_&amp;id=<?= $id ?>&amp;action=update" style="border: 0px; text-decoration: none;">
