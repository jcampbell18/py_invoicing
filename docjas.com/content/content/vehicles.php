                            <td colspan="2" style="width: 940px; margin: 0px; padding: 20px 36px 40px 40px; border: 0px solid #000;">
                                <div style="width: 940px; margin: 0px; border: 0px; padding: 0px 0px 0px 0px;">
                                    <table style="width: 940px; margin: 0px; padding: 0px 0px 0px 0px; border: 0px; border-collapse: collapse;">
                                        <tr>
                                            <td style="background: url('imgs/receipts_bar.jpg') no-repeat; color: #7e7878; font-size: 11px; font-family: Tahoma, Arial, sans-serif; width: 940px; height: 38px;">&nbsp;</td>
                                        </tr>
                                        <tr>
...
?>            
                                                            <div style="margin: 0px; padding: 3px 25px 0px 25px; border: 0px; text-align: left; vertical-align: top;">
                                                                <table>
                                                                    <tr>
                                                                        <td style="width: 80px; height: 37px; padding: 0px;"><?= $man_year ?></td>
                                                                        <td style="width: 176px; height: 37px; padding: 0px;"><?= $make ?></td>
                                                                        <td style="width: 200px; height: 37px; padding: 0px;"><?= $model ?></td>
                                                                        <td style="width: 200px; height: 37px; padding: 0px;"><?= $submodel ?></td>
                                                                        <td style="width: 200px; height: 37px; padding: 0px;"><?= $engine ?></td>
                                                                        <td style="width: 44px; height: 37px; padding: 0px;">
                                                                            <a href="main.php?page=vehicles_&amp;id=<?= $id ?>&amp;action=update" style="border: 0px; text-decoration: none;">
