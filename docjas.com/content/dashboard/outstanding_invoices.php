                            <td colspan="2" style="width: 940px; height: 240px; margin: 0px; padding: 40px 36px 40px 40px; border: 0px solid #000;">
                                <div style="width: 940px; margin: 0px; border: 0px; padding: 0px 0px 0px 0px;">
                                    <table style="width: 940px; margin: 0px; padding: 0px 0px 0px 0px; border: 0px; border-collapse: collapse;">
                                        <tr>
                                            <td style="background: url('imgs/outstanding_invoices.jpg') no-repeat; color: #7e7878; font-size: 11px; font-family: Tahoma, Arial, sans-serif; width: 940px; height: 76px;">&nbsp;</td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <div style="margin: 0px; padding: 3px 25px 0px 25px; border: 0px; text-align: left; vertical-align: top;">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 120px; height: 37px; padding: 0px;">$<?= number_format($amount, 2, '.', ',') ?></td>
