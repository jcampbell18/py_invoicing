...
/* Converting Invoice ID to Invoice # */
    ...
    $folder_path = 'projectsites/'.$address.'/Receipts/INV_'.$i_inv.'/';
?>
                                                    ...
                                                    <tr>
                                                        <td colspan="8" style="background: url('imgs/bar_empty.jpg') no-repeat; color: #423a3a; font-size: 12px; font-family: Tahoma, Arial, sans-serif; width: 940px; height: 42px; padding: 0px;">
                                                            <div style="vertical-align: middle; margin: 0px auto; color: #999999; font-size: 12px; font-family: Tahoma, Arial, sans-serif; padding: 15px 0px 0px 42px; width: 900px; height: 30px;">
                                                                <?= $address ?> - Receipt #<?= $img_num ?> from <?= $img_date ?>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
?>
                                                        <td style="background: #f6f6f6; color: inherit; width: 100px; vertical-align: top; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left; padding: 10px 10px 10px 10px;">
...
?>                                                                                                                
                                                    ...
                                                    <tr>
                                                        <td style="background: inherit; color: inherit; width: 940px; height: 52px; vertical-align: middle; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left; padding: 10px 0px 0px 0px; margin: 0px;">
                                                            <input type="image" src="imgs/button_back_S.jpg" style="width: 160px; height: 42px; margin: 0px auto; padding: 0px; border: 0px; text-decoration: none;" value="go back" onclick="window.location='main.php?page=invoices_receipts&amp;id=<?= $_GET[id] ?>&amp;pid=<?= $_GET[pid] ?>';">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
