...
// create invoice
    if ($_POST['submit'] == "create") {
        echo("Hello World");
        $sql = "INSERT INTO $tb SET name='{$_POST['name']}', shortdesc='{$_POST['shortdesc']}'";
		mysql_query($sql);
...
// update invoice
    if ($_POST['submit'] == "update") {
        $sql = "UPDATE $tb SET name='{$_POST['name']}', shortdesc='{$_POST['shortdesc']}' WHERE id='{$_GET['id']}'";        
        mysql_query($sql);
...
<? } ?>
                                                        <tr>
                                                            ...
                                                            <td rowspan="3" style="background: inherit; color: inherit; width: 111px; vertical-align: middle; border: 0px; padding: 0px 0px 0px 0px; margin: 0px auto;">
                                                                <div style="padding-left: 15px;">
                                                        ...
                                                        <tr>
                                                            <td style="background: url('imgs/main_column.jpg') no-repeat; color: inherit; width: 235px; height: 36px; vertical-align: middle; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: right; padding: 0px 0px 0px 0px;">
                                                                <div style="padding-right: 10px;">Short Description</div>
                                                            </td>
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 594px; height: 36px; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="shortdesc" value="<?= $shortdesc ?>" style="width: 450px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
